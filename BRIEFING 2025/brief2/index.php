...
<head>
   ...
   <style>
    ...
    /* Header específico - SIN animaciones ni efectos hover - ANULAR COMPLETAMENTE STYLE.CSS */
    .header-logo-row,
    .header-logo-row td,
    .header-logo-row th,
    .header-logo-row img,
    ...
    /* Forzar colores específicos del header */
    .header-logo-row td {
        background-color: #ffffff !important;
    }
    ...
    /* Anular específicamente las reglas del style.css */
    .header-logo-row td {
        transition: none !important;
        transform: none !important;
    }
                ...
                <form id="briefing-form" action='procesar.php' method="POST">
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            <!-- Header con logo y información - SIN ANIMACIONES -->
                            <tr class="header-logo-row">
                                ...
                                <td class="text-center" style="background: #dff2fd !important;">
                                    <div class="mb-2">
